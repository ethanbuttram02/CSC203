...
public class ExampleMap {
   ...
   */
  public static List<String> highScoringStudents (Map<String, List<part1.CourseGrade>> scoresByApplicantName, int scoreThreshold) {
     ...
     * the given threshold.
     */
    for (Map.Entry<String, List<part1.CourseGrade>> current : scoresByApplicantName.entrySet()) {
      List<part1.CourseGrade> scores = current.getValue();
      int count = 0;

      for (part1.CourseGrade grade: scores) {
